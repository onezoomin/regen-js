	...
	fromJSON(object: any): RequestBeginBlock {
		...
		message.lastCommitInfo =
			...
			object.lastCommitInfo !== null
				...
				: undefined;
		message.byzantineValidators = (object.byzantineValidators ?? []).map(
...
export const Response = {
	...
	fromPartial<I extends Exact<DeepPartial<Response>, I>>(
		object: I
	): Response {
		const message = { ...baseResponse } as Response;
		message.exception =
		...
		message.loadSnapshotChunk =
			object.loadSnapshotChunk !== undefined &&
			object.loadSnapshotChunk !== null
				? ResponseLoadSnapshotChunk.fromPartial(
		...
		message.applySnapshotChunk =
			object.applySnapshotChunk !== undefined &&
			object.applySnapshotChunk !== null
				? ResponseApplySnapshotChunk.fromPartial(
						object.applySnapshotChunk
				  )
				: undefined;
		return message;
...
export const ResponseEndBlock = {
	...
	fromJSON(object: any): ResponseEndBlock {
		const message = { ...baseResponseEndBlock } as ResponseEndBlock;
		message.validatorUpdates = (object.validatorUpdates ?? []).map(
			(e: any) => ValidatorUpdate.fromJSON(e)
		);
		message.consensusParamUpdates =
...
export const TxResult = {
	...
	fromPartial<I extends Exact<DeepPartial<TxResult>, I>>(
		object: I
	): TxResult {
		const message = { ...baseTxResult } as TxResult;
		message.height =
...
export const VoteInfo = {
	...
	fromPartial<I extends Exact<DeepPartial<VoteInfo>, I>>(
		object: I
	): VoteInfo {
		const message = { ...baseVoteInfo } as VoteInfo;
		message.validator =
...
export const Evidence = {
	...
	fromPartial<I extends Exact<DeepPartial<Evidence>, I>>(
		object: I
	): Evidence {
		const message = { ...baseEvidence } as Evidence;
		message.type = object.type ?? 0;
...
export const Snapshot = {
	...
	fromPartial<I extends Exact<DeepPartial<Snapshot>, I>>(
		object: I
	): Snapshot {
		const message = { ...baseSnapshot } as Snapshot;
		message.height =
