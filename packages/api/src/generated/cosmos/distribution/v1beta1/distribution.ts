...
export const ValidatorAccumulatedCommission = {
	...
	fromPartial<
		I extends Exact<DeepPartial<ValidatorAccumulatedCommission>, I>
	>(object: I): ValidatorAccumulatedCommission {
		const message = {
			...baseValidatorAccumulatedCommission,
		} as ValidatorAccumulatedCommission;
		message.commission =
...
export const DelegationDelegatorReward = {
	...
	fromJSON(object: any): DelegationDelegatorReward {
		...
		message.validatorAddress =
			...
			object.validatorAddress !== null
				...
				: '';
		message.reward = (object.reward ?? []).map((e: any) =>
			DecCoin.fromJSON(e)
		);
		return message;
	},
	...
	fromPartial<I extends Exact<DeepPartial<DelegationDelegatorReward>, I>>(
		...
		message.reward =
			object.reward?.map((e) => DecCoin.fromPartial(e)) || [];
		return message;
	},
};
