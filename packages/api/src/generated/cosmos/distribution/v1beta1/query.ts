...
export const QueryValidatorOutstandingRewardsResponse = {
	...
	fromPartial<
		I extends Exact<
			DeepPartial<QueryValidatorOutstandingRewardsResponse>,
			I
		>
...
export const QueryValidatorCommissionRequest = {
	...
	fromPartial<
		I extends Exact<DeepPartial<QueryValidatorCommissionRequest>, I>
	>(object: I): QueryValidatorCommissionRequest {
		const message = {
			...baseQueryValidatorCommissionRequest,
		} as QueryValidatorCommissionRequest;
		message.validatorAddress = object.validatorAddress ?? '';
...
export const QueryDelegationRewardsResponse = {
	...
	fromPartial<
		I extends Exact<DeepPartial<QueryDelegationRewardsResponse>, I>
	>(object: I): QueryDelegationRewardsResponse {
		const message = {
			...baseQueryDelegationRewardsResponse,
		} as QueryDelegationRewardsResponse;
		message.rewards =
			object.rewards?.map((e) => DecCoin.fromPartial(e)) || [];
		return message;
	},
};
...
export const QueryDelegationTotalRewardsResponse = {
	...
	fromJSON(object: any): QueryDelegationTotalRewardsResponse {
		...
		message.total = (object.total ?? []).map((e: any) =>
			DecCoin.fromJSON(e)
		);
		return message;
	},
...
export class QueryClientImpl implements Query {
	...
	DelegationTotalRewards(
		...
		const data =
			QueryDelegationTotalRewardsRequest.encode(request).finish();
		const promise = this.rpc.request(
			'cosmos.distribution.v1beta1.Query',
			'DelegationTotalRewards',
			data
	...
	DelegatorWithdrawAddress(
		...
		const data =
			QueryDelegatorWithdrawAddressRequest.encode(request).finish();
		const promise = this.rpc.request(
			'cosmos.distribution.v1beta1.Query',
			'DelegatorWithdrawAddress',
			data
